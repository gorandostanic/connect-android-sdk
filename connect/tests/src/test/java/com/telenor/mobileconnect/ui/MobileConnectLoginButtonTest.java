...
public class MobileConnectLoginButtonTest {
    ...
    @Test
    public void clickingLoginButtonWithFailingOperatorDiscoveryResultStartsOperatorSelectionActivity() {
        WELL_KNOWN_API_MAP.put(MOCKED_WELL_KNOWN_ENDPONT, MOCKED_VALID_WELL_KNOWN_API);
                ...
                new BooleanSupplier() {
                    @Override
                        public boolean getAsBoolean() {
                            ...
                            return ConnectUtils.OPERATOR_SELECTION_ACTION
                                    .equals(intentForResult.intent.getAction());
                            }
                }
                ), is(true));
        }
